...
class Avro4SSerde {
  ...
  object binary {
    ...
    implicit def binaryAvro4sMessageAdapter[T](implicit p: Platform, enc: Encoder[T], dec: Decoder[T], sf: SchemaFor[T]): p.MessageAdapter[T] =
  ...
  object json {
    ...
    implicit def jsonAvro4sMessageAdapter[T](implicit p: Platform, enc: Encoder[T], dec: Decoder[T], sf: SchemaFor[T]): p.MessageAdapter[T] =
      new p.MessageAdapter[T] {
